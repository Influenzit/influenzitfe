        ...
        <Container>
            <Top>
                ...
                <Details>
                    ...
                    <p>Thanks for confirming the completion of this Project. The campain status has been updated and payment made to the respective influencer account. Kindlygive a review on the Project to help others decide better.</p>
                </Details>
            </Top>
...
ProjectCompleted.getLayout = (page) => (
    <LandingLayout>
        {page}
    </LandingLayout>
)
