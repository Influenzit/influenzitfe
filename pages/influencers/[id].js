...
const CreatorProfile = () => {
  ...
  const generateICountryData = () => {
    ...
    let countryObj = JSON.parse(
      inData?.analytics?.instagram?.audience_country ?? "{}"
    );
  ...
  const { data: influencerData, refetch: refetchInfluencerData } = useQuery(
    ["get-influencer"],
    async () => {
  ...
  const { data: influencersData, refetch: refetchInfluencersData } = useQuery(
    ["get-influencers"],
    async () => {
  ...
  return (
    <Container>
      {inData ? (
              ...
              <BottomSection>
                <LeftSection>
                  ...
                  <DataSection>
                        ...
                        <AnalyticStats>
                          <Stat>
                            <h1>
                              {numberFormatter(
                                Number(
                                  inData?.analytics?.instagram?.followers_count
                                )
                              )}
                            </h1>
                            <p>Followers</p>
                          ...
                          <Stat isCenter>
                            <h1>
                              {numberFormatter(
                                inData?.analytics?.instagram?.reach
                              )}
                            </h1>
                            <p>Reach</p>
                          </Stat>
                          ...
                          <Flex>
                            ...
                            <StatsCard>
                              ...
                              <div>
                                ...
                                <h1>
                                  {numberFormatter(
                                    Number(inData?.analytics?.instagram?.likes)
                                  )}
                                </h1>
                              </div>
                            </StatsCard>
                          ...
                          <Flex>
                            <StatsCard>
                              ...
                              <div>
                                ...
                                <h1>
                                  {numberFormatter(
                                    Number(
                                      inData?.analytics?.instagram?.comments
                                    )
                                  )}
                                </h1>
                              </div>
                            ...
                            <StatsCard>
                              ...
                              <div>
                                ...
                                <h1>
                                  {numberFormatter(
                                    inData?.analytics?.instagram?.profile_views
                                  )}
                                </h1>
                              </div>
                            </StatsCard>
                        ...
                        <PerformanceCont>
                          <Flex className="flex">
                            <EngagementCard>
                              ...
                              <div id="wrapper">
                                <h1>
                                  {inData?.analytics?.facebook?.engagement}%
                                </h1>
                                <div>
                                  <p>Average</p>
                    ...
                    {currentTab === "instagram" &&
                    inData?.analytics?.instagram_ensemble &&
                    inData?.analytics?.options?.instagram_source ===
                      "ensemble" ? (
                      <Content>
                        <h3>Influencer Summary</h3>
                        ...
                        <AnalyticStats style={{ marginBottom: "20px" }}>
                          <Stat>
                            <h1>
                              {numberFormatter(
                                Number(
                                  inData?.analytics?.twitter?.following_count
                                )
                              )}
                            </h1>
                            <p>Following</p>
                          ...
                          <Stat isCenter>
                            <h1>
                              {numberFormatter(
                                Number(
                                  inData?.analytics?.twitter?.followers_count
                                )
                              )}
                            </h1>
                            <p>Followers</p>
                        ...
                        <AnalyticStats style={{ marginBottom: "20px" }}>
                          <Stat>
                            <h1>
                              {numberFormatter(
                                Number(
                                  inData?.analytics?.tiktok?.following_count
                                )
                              )}
                            </h1>
                            <p>Following</p>
                          ...
                          <Stat isCenter>
                            <h1>
                              {numberFormatter(
                                Number(
                                  inData?.analytics?.tiktok?.follower_count
                                )
                              )}
                            </h1>
                            <p>Followers</p>
                      ...
                      <Content>
                        ...
                        <AnalyticStats>
                          ...
                          <Stat isCenter>
                            <h1>
                              {numberFormatter(
                                inData?.analytics?.youtube?.views
                              )}
                            </h1>
                  ...
                  <SocialWrapper>
                    <Social>
                      ...
                      <div>
                        <h4>INSTAGRAM</h4>
                        <a
                          href={`https://instagram.com/${inData?.instagram}`}
                          target="_blank"
                          rel="noreferrer"
                        >
                          @{inData?.instagram}
                    ...
                    <Social>
                      ...
                      <div>
                        <h4>YOUTUBE</h4>
                        <a
                          href={`https://youtube.com/@${inData?.youtube}`}
                          target="_blank"
                          rel="noreferrer"
                        >
                          @{inData?.youtube}
                  ...
                  <SocialWrapper>
                    <Social>
                      ...
                      <div>
                        <h4>TIKTOK</h4>
                        <a
                          href={`https://tiktok.com/@${inData?.tiktok}`}
                          rel="noreferrer"
                          target="_blank"
                          title={inData?.tiktok}
                        >
                    ...
                    <Social>
                      ...
                      <div>
                        <h4>TWITTER</h4>
                        <a
                          href={`https://twitter.com/${inData?.twitter}`}
                          target="_blank"
                          rel="noreferrer"
                          title={inData?.twitter}
                        >
                          @{inData?.twitter}
                        </a>
                      </div>
                  ...
                  <SocialWrapper>
                    <Social style={{ minWidth: "100%" }}>
                      ...
                      <div>
                        <h4>FACEBOOK</h4>
                        <a
                          href={`https://www.facebook.com/${inData?.facebook}`}
                          target="_blank"
                          rel="noreferrer"
                          title={inData?.facebook}
                        >
                          @{inData?.facebook}
                        </a>
                      </div>
        ...
        >
          <p style={{ textAlign: "center" }}>Fetching Influencer...</p>
        </div>
      )}
    </Container>
  );
};
CreatorProfile.getLayout = (page) => <LandingLayout>{page}</LandingLayout>;
