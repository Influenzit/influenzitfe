...
const Home = () => {
  ...
  const { data: topCampaignsData, refetch: refetchTopCampaignsData } = useQuery(
    ["get-services"],
    async () => {
  ...
  const getRequirement = (req, name) => {
    return JSON.parse(
      req?.requirements.filter((val) => val.name === name)[0]?.value ?? "[]"
    );
  };
  useEffect(() => {
    refetch();
  ...
  return (
    <div>
      <HeroSectionOne>
        <WrapperOne>
          <h1>
            We Connect <span>Influencers</span>, <span>Business Owners</span>{" "}
            and <span>Creators</span>
          </h1>
          <p>
            The number one Influencer marketing Platform For Business Owners,
          ...
          <form>
            ...
            <button
              onClick={(e) => {
                e.preventDefault();
                router.push(
                  `/explore/campaign-requests?search=${searchString}`
                );
              }}
            >
              <span>Search</span>{" "}
        ...
        <WrapperThree>
          <InfoCardM>
            <Info>
              ...
              <p>
                Discover and apply for unique product seeding campaigns tailored
                to your interests and expertise. Gain exposure, collaborate with
                amazing brands, and take your content creation to the next level
                with Influenzit.
              </p>
          ...
          <WrapperFourD $top>
            <h1>
              <span>Featured Campaign Requests</span>
            </h1>
                ...
                requestList.map((req, i) => {
                  return (
                    <CampaignCard
                      ...
                      refetch={refetch}
                      followers={`${
                        getRequirement(req, "followers")[0] ?? ""
                      } - ${getRequirement(req, "followers")[1] ?? ""}`}
                      engagements={`${
                        getRequirement(req, "engagement_rate")[0] ?? ""
                      }% - ${getRequirement(req, "engagement_rate")[1] ?? ""}%`}
                      key={i}
                      reqPlatform={JSON.parse(
                        req.requirements.filter(
                          (val) => val.name === "platforms"
                        )[0]?.value ?? "[]"
                      )}
                    />
                  );
          ...
          <InfoCardM>
            ...
            <Info leftP>
              ...
              <p>
                Efficiently identify and engage with the most relevant
                influencers for your brand. Drive massive sales and revenue
                through authentic collaborations. We make finding the perfect
                influencer for your marketing campaigns easy and effective with
                our product seeding campaign setup.{" "}
              </p>
          ...
          <InfoCardM>
            <Info>
              ...
              <p>
                Streamline your influencer marketing campaigns with
                Influenzit&apos;s intuitive project management tools.
                Effortlessly plan, execute, and monitor your campaigns, keeping
                all your collaborations organized and on track. Our
                user-friendly interface allows you to manage multiple projects
                simultaneously, ensuring clear communication and timely
                progress.
              </p>
              <Link href="/product-seeding" passHref>
                <a>Get Started</a>
          ...
          <InfoCardM>
            ...
            <Info leftP>
              ...
              <p>
                Simplify your influencer payment process with Influenzit&apos;s
                secure and efficient escrow system. Our platform enables you to
                manage payments effortlessly, ensuring timely compensation for
                the influencers you collaborate with. Funds are securely held in
                escrow until the campaign has been marked and accepted as
                completed by the business owner. This added layer of protection
                fosters trust between both parties and helps to prevent payment
                disputes.
              </p>
      ...
      <HeroSectionFour>
        <WrapperFour>
          <h1>
            A whole world of <span>results-focused</span> influencers at your
            fingertips.
          </h1>
          ...
          <NicheWrapper>
            <NicheCard
              onClick={() => router.push(`/explore/influencers?industry=food`)}
            >
              <ImgW1 id="anim">
                <Image
                  src="/niche1.png"
            ...
            <NicheCard
              onClick={() =>
                router.push(`/explore/influencers?industry=fashion`)
              }
            >
              <ImgW1 id="anim">
                <Image
            ...
            <NicheCard
              onClick={() =>
                router.push(`/explore/influencers?industry=travel`)
              }
            >
              <ImgW1 id="anim">
                <Image
            ...
            <NicheCard
              onClick={() =>
                router.push(`/explore/influencers?industry=lifestyle`)
              }
            >
              <ImgW1 id="anim">
                <Image
            ...
            <NicheCard
              onClick={() =>
                router.push(`/explore/influencers?industry=technology`)
              }
            >
              <ImgW1 id="anim">
                <Image
            ...
            <NicheCard
              onClick={() =>
                router.push(`/explore/influencers?industry=family`)
              }
            >
              <ImgW1 id="anim">
                <Image
            ...
            <NicheCard
              onClick={() =>
                router.push(`/explore/influencers?industry=health`)
              }
            >
              <ImgW1 id="anim">
                <Image
            ...
            <NicheCard
              onClick={() => router.push(`/explore/influencers?industry=hair`)}
            >
              <ImgW1 id="anim">
                <Image
                  src="/niche8.png"
...
Home.getLayout = (page) => {
  return (
    <LandingLayout
      description={
        "Influenzit is the premier platform connecting Nigerian influencers with businesses. Our platform streamlines the influencer marketing process, making it easy for businesses to find and collaborate with the right influencers for their brand. Join our community today and take your influencer marketing to the next level"
      }
    >
      {page}
    </LandingLayout>
