      ...
      <Wrapper>
        <TableWrapped>
                    ...
                    <Tr key={i}>
                      ...
                      <Td cellWidth="80px">
                        <ActionBtn
                          onClick={() =>
                            router.push(
                              `/admin/u/dashboard/businesses/${val.id}`
                            )
                          }
                        >
                          View
          ...
          <TableFooter>
            <p>
              Showing{" "}
              {(businessList.current_page - 1) * businessList.per_page +
                businessList.data.length}{" "}
              of {businessList.total}
            </p>
            <Pagination>
              <NavBtn
                onClick={() =>
                  businessList.prev_page_url &&
                  setGetUrl(
                    businessList.prev_page_url.replace(
              ...
              <NavBtn
                onClick={() =>
                  businessList.next_page_url &&
                  setGetUrl(
                    businessList.next_page_url.replace(
                      process.env.NEXT_PUBLIC_API_URI + "/api/v1",
                      ""
                    )
                  )
