  ...
  return (
    <Container>
      <Wrapper>
        <Top>
          <MainSection>
            ...
            <p>
              ...
              live chat for any questions, feedback, or inquiries.
            </p>
            <ul>
              <li>
              ...
              <li>
                <Link href="tel:+2348028723803">+2348028723803</Link>
              </li>
            </ul>
          </MainSection>
          <Section>
          ...
          <Section>
            ...
            <ul>
              ...
              <li>
                <Link href="/explore/creators">Find Creators</Link>
              </li>
              <li>
                <Link href="/explore/services">Buy Services</Link>
              </li>
            </ul>
          </Section>
          <Section>
        ...
        <Bottom>
          <p>
            &copy; 2023. Influenzit is owned and operated by ASCEND BRAND
