...
import { GetStartedBtn, Logo, NavLinks, ProfilePicWrapper, ResponsiveNav, SearchBtn, SearchBtnC, SearchBtnResponsive, SearchByBtn, SearchByOption, SearchContainer, SidebarBtn } from './style'

import Image from 'next/image'
import Link from 'next/link'
import { BagIcon, BellIcon, BoxIcon, CollaborationIcon, ExploreIcon, HamburgerIcon, HashTagIcon, LogoutIcon, MailIcon, SettingsIcon, UserIcon, WalletIcon } from '../../assets/svgIcons'
...
import { Center, ConnectDropdown, ConnectDropdownCont, Container, Controls, ControlsA, LoginBtn, Qlinks, Right, UserBtn, UserDropdown, Wrapper } from '../nav/style'
            ...
            </div>
            {
                isLoggedIn ? (
                    <Right>
                        ...
                        <ControlsA showNotify={false} showMessage={false} style={{ border: "none" }}>
                        <ConnectDropdown 
                            className="explore"
                        ...
                        <UserBtn onClick={() => handleProfileOpen()} ref={profileRef}>
                            ...
                            {showDropdown && (
                                <UserDropdown>
                                <div id="user-d" onClick={() => router.push("/admin/u/dashboard")}>
                                    <h4>{user.name}</h4>
                                    <p>Admin</p>
                                </div>
