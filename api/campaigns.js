...
export const getCampaignPosts = (id) => {
  return axiosInstance().get(`/campaigns/${id}/posts`);
};
export const getCampaignPostsMetrics = (id) => {
  return axiosInstance().get(`/campaigns/${id}/posts/metrics`);
};
